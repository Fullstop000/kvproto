...
func (*KeyRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_ea803a79336ea0d2, []int{0}
}
...
type Request struct {
	...
	ScanAllLocks         bool     `protobuf:"varint,6,opt,name=scan_all_locks,json=scanAllLocks,proto3" json:"scan_all_locks,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_ea803a79336ea0d2, []int{1}
}
...
func (m *Request) GetScanAllLocks() bool {
	if m != nil {
		return m.ScanAllLocks
	}
	return false
}
...
type Response struct {
	...
	AllLocks             []*kvrpcpb.LockInfo                                    `protobuf:"bytes,7,rep,name=all_locks,json=allLocks" json:"all_locks,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                               `json:"-"`
	XXX_unrecognized     []byte                                                 `json:"-"`
	XXX_sizecache        int32                                                  `json:"-"`
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_ea803a79336ea0d2, []int{2}
}
...
func (m *Response) GetAllLocks() []*kvrpcpb.LockInfo {
	if m != nil {
		return m.AllLocks
	}
	return nil
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ScanAllLocks", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllLocks", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AllLocks = append(m.AllLocks, &kvrpcpb.LockInfo{})
			if err := m.AllLocks[len(m.AllLocks)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("coprocessor.proto", fileDescriptor_coprocessor_ea803a79336ea0d2) }

var fileDescriptor_coprocessor_ea803a79336ea0d2 = []byte{
	// 498 bytes of a gzipped FileDescriptorProto
	,
}
